          ...
          <form onSubmit={onSubmit}>
            <div className="flex mb-2">
              <div className="w-2/3 pr-4">
                ...
                <input type="text" className="border rounded px-3 py-2 w-full" defaultValue={domain} onInput={({ target }: any) => { setDomain(target.value.trim()) }}/>
              ...
              <div className="w-1/3">
                ...
                <input type="text" className="border rounded px-3 py-2 w-full" defaultValue={port} onInput={({ target }: any) => { setPort(target.value.trim()) }}/>
            ...
            <div className="flex">
              <div className="block pr-2 w-1/2">
                ...
                <input type="text" className="border rounded px-3 py-2 w-full" defaultValue={namespaceId} onInput={({ target }: any) => { setNamespaceId(target.value.trim()) }}/>
              </div>
              <div className="block pl-2 w-1/2">
                <label className="block mb-1 text-lg">Data</label>
                <input type="text" className="border rounded px-3 py-2 w-full" defaultValue={data} onInput={({ target }: any) => { setData(target.value.trim()) }}/>
              </div>
            </div>
            ...
            {error && (
              <div className="bg-red-100 p-4 my-6 rounded border border-red-200 text-red-900 font-bold flex items-center">
